...
<div class="together1" style="position:relative">
	<div class="top">
		...
		<c:when test="${user==1}">
			...
			<li class="topli"><a class="link" href="<%=basePath%>/account.jsp">客户信息</a></li>
			</c:when>
			<c:when test="${user==2}">
			...
			<li class="topli"><a class="link" href="Cart_get.action">购物车()</a></li>	
				</c:when>
				<c:when test="${user==3}">
			<li class="topli"><span class="link">卖家你好，欢迎光临！</span></li>
		    <li class="topli"><a class="link" href="<%=basePath%>/together.jsp">首页</a></li>
